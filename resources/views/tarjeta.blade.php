  ...
  <body class="bg-blue-50">
    <div class="m-4">
      <div class="credit-card w-full sm:w-auto shadow-lg mx-auto rounded-xl bg-white" x-data="creditCard">
          ...
          >
            ...
            <div class="front bg-transparent text-lg w-full text-white px-12 absolute left-0 bottom-12">
              ...
              <div class="flex flex-row justify-between">
                <p x-text="cardholder !== '' ? cardholder : 'Nombre propietario'"></p>
                <div class="">
        ...
        <main class="mt-4 p-4">
          <h1 class="text-xl font-semibold text-gray-700 text-center">Crear Tarjeta</h1>
          <form method="POST" action="{{ route('crear') }}" id="formulario">
            @csrf
            <div class="my-3">
              <input
                type="text"
            ...
            <div class="my-3 flex flex-col">
              <div class="mb-2">
                <label for="" class="text-gray-700">Caducidad</label>
              </div>
